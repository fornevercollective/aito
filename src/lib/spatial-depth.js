...
export function shellRadius(slot, base = 1.15, nest = 0.22) {
 ...
 */
export function nestedParallaxGain(radius, parallax = 0.65) {
...
export function depthGradeTint(depth01, nearWarm = 0.35, farCool = 0.45) {
...
export function readBoothBridge() {
    if (typeof window === "undefined")
        return null;
    const w = window;
    if (!w.aitoBoothHand && !w.aitoBoothDepth)
        return null;
    return {
