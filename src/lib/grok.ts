...
export interface GrokEditResponse {
  ...
  lutName?: string; // e.g. "kodak-portra-400" or custom
  maskPrompt?: string; // description for SAM to create/refine mask
  intensity?: number; // overall strength 0-1
  notes?: string;

  // New tool calling support
  toolCalls?: Array<{
    name: 'apply_lut_preset' | 'create_custom_lut' | 'tether_capture' | 'suggest_film_look';
